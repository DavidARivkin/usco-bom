...
var Bom = (function () {
  ...
  _createClass(Bom, {
    registerPart: {
      ...
      value: function registerPart(partData, implementations, instances) {
        var entryDefaults = {
          name: "",
          description: "",
          version: "0.0.0",
    ...
    registerImplementationInFakeBOM: {
      ...
      value: function registerImplementationInFakeBOM(meshUri, partName) {
